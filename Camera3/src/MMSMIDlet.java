...
//  private InfoScreen infoScreen;
    ...
    private Form form;
    private Command getImage,  storeImage,  exit,  atras,  camera,  guardar,  crear,  editar,  eliminar,  transferir;
    private Image img;
    int cont = 0;
    ...
    private List lista;
    private Vector dato;
    private Datos datos = new Datos("", "", "", "", "", "", null, null);
    private Datos d;
